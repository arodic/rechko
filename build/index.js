...
`+this.boardGrid}changed(){var e=this.gameStats.reduce(function(e,t){return Math.max(e,t)},-1/0);this.template([["h2",{class:"answer"},this.message],["div",{class:"board"},this.boardGrid],["h3","Статистика"],["div",{class:"grid"},[["span",{class:"count"},String(this.gamesStarted)],["span",{class:"count"},String(this.gamesFinished)],["span",{class:"count"},String(this.gamesWon)],["span","започетих"],["span","одиграних"],["span","решених"]]],["h4","Дистрибуција погодака:"],["div",{class:"distribution"},[["div",[["span","1"],["span",{style:{flex:this.gameStats[0]/e}},String(this.gameStats[0])]]],["div",[["span","2"],["span",{style:{flex:this.gameStats[1]/e}},String(this.gameStats[1])]]],["div",[["span","3"],["span",{style:{flex:this.gameStats[2]/e}},String(this.gameStats[2])]]],["div",[["span","4"],["span",{style:{flex:this.gameStats[3]/e}},String(this.gameStats[3])]]],["div",[["span","5"],["span",{style:{flex:this.gameStats[4]/e}},String(this.gameStats[4])]]],["div",[["span","6"],["span",{style:{flex:this.gameStats[5]/e}},String(this.gameStats[5])]]],["div",[["span","x"],["span",{style:{flex:this.gameStats[6]/e}},String(this.gameStats[6])]]]]],["io-icon",{icon:"icons:close","on-click":this.onClose}],this.win||this.finish?["button",{"on-click":this.onShare},[["span","Подели"],["io-icon",{icon:"buttons:share"}]]]:null])}}RegisterIoElement(RechkoStats);class RechkoPuppies extends RechkoPopup{static get Style(){return`
    ...
    `}static get Properties(){return{shareText:"Помозите Речку да удоми Нору и Леу!",shareLink:"https://rechko.com/#puppies=true"}}async onShare(){try{await navigator.share({text:this.shareText+"\n"+this.shareLink})}catch(e){navigator.clipboard.writeText(this.shareText+"\n"+this.shareLink),this.dispatchEvent("message",{message:"Линк копиран!"})}}changed(){this.template([["h3",{class:"answer"},this.shareText],["io-icon",{icon:"icons:close","on-click":this.onClose}],["div",{class:"puppies"},[["img",{src:"images/nora.jpeg"}],["img",{src:"images/lea.jpeg"}]]],["button",{"on-click":this.onShare},[["span","Подели"],["io-icon",{icon:"buttons:share"}]]],["div",{class:"rajka"},[["div",[["p","Узраст: 3 месеца"],["p","Мајка: Рајка (Епањел бретон)"],["p","Одбачена скотна женка удомљена у нашем домаћинству. Донела је на свет Нору и Леу којима тражимо нови дом. Штенце доносимо лично на територији Србијe и региона!"],["a",{href:"https://www.instagram.com/stories/highlights/17947876616265094/",target:"_blank"},"Погледајте више на Инстаграму"]]],["img",{src:"images/rajka.jpeg"}]]]])}}RegisterIoElement(RechkoPuppies);class RechkoSettings extends RechkoPopup{static get Style(){return`
      :host io-switch {
        --io-line-height: 30px;
        --io-item-height: 40px;
      }
