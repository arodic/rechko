...
`),IoThemeSingleton.theme=JSON.parse(localStorage.getItem("darkTheme")||"false")?"dark":"light";const foolDay=19083,isFool=localStorage.getItem("isFool"),today=Math.floor((Number(new Date)+36e5)/864e5),answer=getWordOfTheDay(today),board=history$1.load(today)||Array.from({length:6},()=>Array.from({length:5},()=>({letter:"",state:0})));let allHistory=history$1.loadAll();const replaceLatinKeys=[["q","w","e","r","t","y","u","i","o","p","š","đ","ž","a","s","d","f","g","h","j","k","l","č","ć","x","c","v","b","n","m"],["љ","њ","е","р","т","з","у","и","о","п","ш","ђ","ж","а","с","д","ф","г","х","ј","к","л","ч","ћ","џ","ц","в","б","н","м"]],replaceEnglishKeys=[["q","w","e","r","t","y","u","i","o","p","[","]","\\","a","s","d","f","g","h","j","k","l",";","'","x","c","v","b","n","m"],["љ","њ","е","р","т","з","у","и","о","п","ш","ђ","ж","а","с","д","ф","г","х","ј","к","л","ч","ћ","џ","ц","в","б","н","м"]];class RechkoApp extends IoElement{static get Style(){return`
      :host {
        display: flex;
        position: relative;
        height: 100%;
